...
('includeUppecase')
const includeNumbersElement = document.getElementById('includeSymbols')
...
form.addEventListener('submit', e => {
    ...
    const includeUppercase = includeUppercaseElement.cheked
    const includeUppercase = includeNumbersElement.cheked
    const includeUppercase = includeSymbolsElement.cheked
...
function generatePassword(characterAmount, includeUppercase,
     includeNumbers, includeSymbols) {
        ...
        if (includeNumbers) charCodes.concat(SYMBOL_CHAR_CODES)
